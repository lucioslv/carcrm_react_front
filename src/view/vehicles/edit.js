...
export default function VehicleEdit(props) {
    ...
    return (
        <>
            ...
            <Header title="Veículo - Gestão" button={<Button onClick={() => dispatch(update(data.vehicle))} color="inherit" className="ms-auto">SALVAR</Button>}/>
                ...
                {(isLoading) ? <div className="d-flex justify-content-center mt-5 pt-5"><CircularProgress/></div> :
                    <div className="row">
                        <div className="col-md-7">
                            ...
                            <>
                            <h3 className="font-weight-normal mt-4 mb-4">Itens Opcionais</h3>
                            <div className="card card-body" onClick={() => setState({...state, tips: 1})}>
                                <div className="row">
